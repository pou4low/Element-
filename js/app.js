(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-popular")) new core(".slider-popular", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 6.5,
            ...
            loop: true,
            navigation: {
                prevEl: ".slider-popular__arrow.swiper-button-prev",
                nextEl: ".slider-popular__arrow.swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".slider-more")) new core(".slider-more", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 6.5,
            ...
            loop: true,
            navigation: {
                prevEl: ".slider-more__arrow.swiper-button-prev",
                nextEl: ".slider-more__arrow.swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
    ...
    const slider = document.querySelector(".slider-page-reviews");
    let mySwiper;
    ...
    const sliderSecond = document.querySelector(".images-preview__slider");
    let mySwiperFirst;
    let mySwiperSecond;
    function desktopSlider() {
        if (document.querySelector(".body-product__images")) {
            if (window.innerWidth > 478.98 && "false" == sliderSecond.dataset.mobile) {
                mySwiperSecond = new core(".images-preview__slider", {
            ...
            if (window.innerWidth <= 478.98) {
                sliderSecond.dataset.mobile = "false";
                if (sliderSecond.classList.contains("swiper-initialized")) {
                    mySwiperSecond.destroy();
                    mySwiperSecond = null;
                }
            }
            mySwiperFirst = new core(".images-product__slider", {
                modules: [ Navigation, Thumb, Controller, EffectFade, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 0,
                ...
                navigation: {
                    prevEl: ".images-product__arrow.swiper-button-prev",
                    nextEl: ".images-product__arrow.swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
    ...
    function headerScroll() {
        if (document.querySelector(".main")) {
            ...
            header.style.backgroundColor = "#7F713E";
        }
    }
    setTimeout((() => {
...
***************************************************************************** */
    ...
    if (document.querySelector("#marquee1")) {
        ...
        let text = "Предложение для дизайнеров <span>/</span>".repeat(10);
        marqueeInner.innerHTML = text;
        const marquee1 = document.querySelector("#marquee1");
        animateMarquee(marquee1, 3e4);
    }
    if (document.querySelector("main.contacts")) {
        let link = document.querySelector("#contacts");
        link.classList.add("_active");
    }
    if (document.querySelector("main.catalog-sofa")) {
        let link = document.querySelector("#catalog");
        link.classList.add("_active");
    }
    if (document.querySelector("main.productcard")) {
        let link = document.querySelector("#catalog");
        link.classList.add("_active");
    }
    if (document.querySelector("main.reviews-comment")) {
        let link = document.querySelector("#reviews");
        link.classList.add("_active");
    }
    window["FLS"] = true;
    isWebp();
